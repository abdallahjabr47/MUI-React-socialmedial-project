...
import { TextField, Stack, ButtonGroup, Button } from '@mui/material';
      ...
      >
        <Box width={400} height={280} bgcolor={"background.default"} color={"text.primary"} p={3} borderRadius={4}>
          ...
          <UserBox onClick={(e) => setOpen(true)}>
            <Avatar sx={{width: 25, height: 25}} src="/static/images/avatar/2.jpg" />
            <Typography fontWeight={500} variant='span'>Jabr</Typography>
          </UserBox>
